---
title: From Brute Force to top 40% on LeetCode
slug: my-dsa-journey
description: My documented journey from how I stumbled upon DSA late in my career to becoming comfortable with complex problem solving.
category:
  - DSA
tags:
  - DSA
pubDate: 2025-11-09
cover: /blog/my-dsa-journey.webp
coverAlt: Constant time solution
author: VV
---
...
![bigO complexity graph](/blog/my-dsa-journey/big-0-complexity.png)
...
![File view showing notes I made on Obsidian for DSA](/blog/my-dsa-journey/obsidian-notes.png)
`Figure 2: My Obsidian notes on DSA`

 Using the open-source whiteboard [Excalidraw](https://excalidraw.com/), I sketched how trees, graphs and other structures worked until the concepts stuck:

![A diagram I used to go through how BSTs work](/blog/my-dsa-journey/binary-tree.png)
...
![My LeetCode contributions in 2024](/blog/my-dsa-journey/leetcode-contributions.png)
...
In summer 2025 I decided to take things more seriously and learn the core DSA categories properly. One of the best resources I found was NeetCode: his [YouTube channel](https://www.youtube.com/@NeetCode) and the [structured roadmap on neetcode.io](https://neetcode.io/roadmap) gave me a clear path through the different techniques. I treated each topic, from backtracking to dynamic programming, as a tool to add to my toolbox. If I could complete that roadmap, I figured, I’d be in a much stronger position for interviews and real‑world problems. I finished most of the list by October 2025.

![My progress with NeetCode's DSA roadmap](/blog/my-dsa-journey/neetcode-roadmap.png)
...
![Progress with LeetCode 75](/blog/my-dsa-journey/leetcode-75.png)

As it stands, 2025-11-03 here is my current LC profile:

![My LeetCode profile in 2025-11-03](/blog/my-dsa-journey/leetcode-profile.png)
